...
namespace Examples_Patterns
{
    internal class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            var patternsBest = GetBestPatternsValue(accuracyBest, 1, dataOhlcv);
        ...
        private static int GetBestPatternsValue(string[] accuracyBest, int multiplier, List<OhlcvObject> items)
        {
            var dataOhlcv = items
                .Select(x => new OhlcvObject()
                {
